 ...
 * );
 */
Twitter.prototype.composeTweet = function(success, failure, tweetText, urlAttach, imageAttach) {
	cordova.exec(success, failure, "TwitterPlugin", "composeTweet", [tweetText, urlAttach, imageAttach]);
};
/**
...
Twitter.prototype.getTWRequest = function(url, params, success, failure, options){
    cordova.exec(success, failure, "TwitterPlugin", "getTWRequest", [url, params, options.requestMethod]);
};
// Plug in to Cordova
