        ...
        if (cordova.callbacks[callbackId]) {
            ...
            if (args.status == cordova.callbackStatus.OK) {
                try {
                    ...
                    Util.log("Error in success callback: "+callbackId+" = "+e);
                }
            }
    ...
    callbackError: function(callbackId, args) {
        if (cordova.callbacks[callbackId]) {
            try {
                ...
                Util.log("Error in error callback: "+callbackId+" = "+e);
            }
    ...
    addConstructor: function(func) {
        channel.onCordovaReady.subscribeOnce(function() {
            try {
                ...
                Util.log("Failed to run constructor: " + e);
            }
        });
    }
};
...
cameraExport.getPicture = function(successCallback, errorCallback, options) {
    ...
    if (typeof successCallback != "function") {
        Util.log("Camera Error: successCallback is not a function");
        return;
    }

    // errorCallback optional
    if (errorCallback && (typeof errorCallback != "function")) {
        Util.log("Camera Error: errorCallback is not a function");
        return;
    }
...
function convertIn(contact) {
    ...
    try {
      ...
      Util.log("Cordova Contact convertIn error: exception creating date.");
    }
    return contact;
}
            ...
            if (entry) {
                if (typeof successCallback === 'function') {
                    ...
                    try {
                        ...
                        Util.log('Error invoking callback: ' + e);
                    }
                }
            }
            else {
...
Entry.prototype.toURI = function(mimeType) {
    Util.log("DEPRECATED: Update your code to use 'toURL'");
...
FileReader.prototype.readAsBinaryString = function(file) {
    ...
    Util.log('method "readAsBinaryString" is not supported at this time.');
};
...
FileReader.prototype.readAsArrayBuffer = function(file) {
    // TODO - Can't return binary data to browser.
    Util.log('This method is not supported at this time.');
};
...
var Media = function(src, successCallback, errorCallback, statusCallback) {
    ...
    if (successCallback && (typeof successCallback !== "function")) {
        Util.log("Media Error: successCallback is not a function");
        return;
    }

    // errorCallback optional
    if (errorCallback && (typeof errorCallback !== "function")) {
        Util.log("Media Error: errorCallback is not a function");
        return;
    }

    // statusCallback optional
    if (statusCallback && (typeof statusCallback !== "function")) {
        Util.log("Media Error: statusCallback is not a function");
        return;
    }
...
Battery.prototype._error = function(e) {
    Util.log("Error initializing Battery: " + e);
};
...
var exec = require('cordova/exec'),
    ...
    compass = {
        ...
        getCurrentHeading:function(successCallback, errorCallback, options) {
            // successCallback required
            if (typeof successCallback !== "function") {
              Util.log("Compass Error: successCallback is not a function");
              return;
            }

            // errorCallback optional
            if (errorCallback && (typeof errorCallback !== "function")) {
              Util.log("Compass Error: errorCallback is not a function");
              return;
            }
...
Device.prototype.getInfo = function(successCallback, errorCallback) {
    ...
    // successCallback required
    if (typeof successCallback !== "function") {
        Util.log("Device Error: successCallback is not a function");
        return;
    }

    // errorCallback optional
    if (errorCallback && (typeof errorCallback !== "function")) {
        Util.log("Device Error: errorCallback is not a function");
        return;
    }
...
logger.logLevel = function(level, message /* , ... */) {
    ...
    // log to the console
    switch (level) {
        case logger.LOG:   Util.log(message); break;
        case logger.ERROR: Util.log("ERROR: " + message); break;
        case logger.WARN:  Util.log("WARN: "  + message); break;
        case logger.INFO:  Util.log("INFO: "  + message); break;
        case logger.DEBUG: Util.log("DEBUG: " + message); break;
    }
};
...
var NetworkConnection = function () {
    ...
    channel.onCordovaReady.subscribeOnce(function() {
        ...
        function (e) {
            ...
            Util.log("Error initializing Network Connection: " + e);
        });
    });
};
...
/**
 * Alerts a message in any available way: alert or Util.log.
 */
utils.alert = function(msg) {
    if (alert) {
        alert(msg);
    } else if (console && Util.log) {
        Util.log(msg);
    }
};
